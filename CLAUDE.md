...
Guitar tablature you write yourself. Next.js 16 App Router, React 19 + React
Compiler, Tailwind v4, Biome. See [README.md](README.md) for the stack table,
the architecture and how to run it; this file is only the rules that are not
obvious from the code, and why each one exists.

The roadmap (`docs/PLAN.md`) is a local working note and is not in the repo.
