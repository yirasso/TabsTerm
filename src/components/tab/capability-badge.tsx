import { CAPABILITY_DETAIL, CAPABILITY_LABEL, type TabCapability } from "@/server/tabs/types";
...
/**
 * Tells the reader what a result actually gives them before they open it —
